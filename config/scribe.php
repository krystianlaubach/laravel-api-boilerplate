...
return [
     ...
     */
    'description' => 'Welcome to ' . config('app.name') . ' API Documentation',
    ...
    'auth' => [
         ...
         */
        'extra_info' => '<aside>For any requests made before the user logs in, please use API secret. Any requests made by logged-in user, please use the user token from the login response.</aside>',
    ],
